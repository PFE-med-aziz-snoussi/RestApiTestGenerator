...
export class ReportComponent implements OnInit {
  ...
  loadSummaryData() {
    this.summaryData = [
      { item: 'Requests', total: this.RequestsTotal, failed: this.RequestsFailedTotal },
      { item: 'Prerequest Scripts', total: this.prerequestScripts, failed: this.prerequestScriptsFailed },
      { item: 'Test Scripts', total: this.testScripts, failed: this.testScriptsFailed },
      { item: 'Assertions', total: this.totalAssertions, failed: this.totalFailedAssertions },
      { item: 'Skipped Tests', total: this.testsSkipped, failed: '-' }
    ];
  }
  ...
  copyToClipboard(value: string): void {
    ...
    try {
      ...
      this.messageService.add({ severity: 'primary', summary: 'Error', detail: 'Copied .' });
